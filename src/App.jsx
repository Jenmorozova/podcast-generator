        ...
        <div className="settings-section">
          ...
          <div className="settings-grid">
              ...
              <div className="voice-selector">
                ...
                <div className="voice-mode-toggle">
                  ...
                  <button
                    className={`btn btn-small ${useExternalTTS ? 'btn-active' : 'btn-inactive'}`}
                    onClick={() => {
                      // Показываем предупреждение о CORS
                      const confirmed = confirm('⚠️ ВНИМАНИЕ: Внешние голоса НЕ РАБОТАЮТ из-за CORS ограничений!\n\n❌ ElevenLabs API блокирует браузерные запросы\n✅ Системные голоса работают всегда\n\nВсё равно попробовать?')
                      
                      if (confirmed) {
                        setUseExternalTTS(true)
                        setTimeout(() => {
                          alert('🔴 Внешние голоса не работают!\n\nПереключитесь на "Системные" голоса для стабильной работы.')
                        }, 1000)
                      }
                    }}
                    title="Внешние голоса (НЕ РАБОТАЮТ из-за CORS)"
                  >
                    🌐 Внешние ❌
                  </button>
                </div>
            ...
            <button
              ...
              onClick={() => alert('❌ ВНЕШНИЕ ГОЛОСА НЕ РАБОТАЮТ!\n\n🔒 Проблема: CORS блокировка\n• ElevenLabs API не поддерживает браузерные запросы\n• Браузер блокирует запросы к внешним API\n• Это стандартная проблема безопасности\n\n✅ РЕШЕНИЕ: Используйте системный голос "Агата"\n• Всегда работает\n• Хорошее качество\n• Никаких проблем с CORS\n\n💡 Совет: Оставайтесь на "Системных" голосах')}
              title="Внешние голоса не работают из-за CORS"
            >
              ❌
            </button>
