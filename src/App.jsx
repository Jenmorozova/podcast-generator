        ...
        <div className="actions-section">
          ...
          <div className="info-text">
            ...
            <p style={{color: '#805ad5', fontWeight: 'bold'}}>
              🔧 <strong>Исправление ошибки "interrupted":</strong> Это нормальное поведение браузера. 
              Если воспроизведение не начинается, попробуйте кликнуть на страницу перед нажатием кнопки.
            </p>
          </div>
