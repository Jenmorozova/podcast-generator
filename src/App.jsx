                ...
                <div className="voice-mode-toggle">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        alert('⚠️ ВНИМАНИЕ: Внешние голоса могут не работать на некоторых устройствах из-за CORS ограничений.\n\nЕсли возникнут проблемы, переключитесь обратно на "Системные" голоса.')
                      }, 500)
                    }}
